...
## 运行
```bash
python -m examples.euler.beginner.lesson_02_load_object.run              # 桌子
python -m examples.euler.beginner.lesson_02_load_object.run --object ball
```
...
| 物体悬空/嵌入地面 | P0 资产落地后默认 z 会校准；当前可改 position 的第三个数 |
