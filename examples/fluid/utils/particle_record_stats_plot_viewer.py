...
Uses ``examples.fluid.fluid_stats`` for parsing so this does not import ``examples.fluid`` (gymnasium).
"""
...
def main() -> None:
    ...
    from examples.fluid.fluid_stats.particle_record_stats_parser import (
        TailState,
