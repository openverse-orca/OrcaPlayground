...
export MJC_PBD_CONFIG=~/OrcaApr24/OrcaPlayground/examples/cloth_3d/cloth_sim_config.phase1_slide.dual_graphic.json
...
```bash
cd ~/OrcaApr24/OrcaPlayground/examples/cloth_3d
export PYTHONPATH=~/OrcaApr24/OrcaLink/Client/Python
