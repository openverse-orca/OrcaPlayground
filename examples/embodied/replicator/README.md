...
command = "python"
args = ["-m", "examples.embodied.replicator.run_actors"]
...
python -m examples.embodied.replicator.run_actors

# 或直接运行
python examples/embodied/replicator/run_actors.py

# Light 复制示例
python -m examples.embodied.replicator.run_lights
```
