...
用法:
    ...
    # 指定 Studio 地址
    python examples/euler/05_force_apply/force_apply.py --addr 192.168.1.100:50051
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Lesson 5: G1 外力应用与状态设置 API 在线验证"
    )
    parser.add_argument(
        "--addr",
...
def main() -> None:
    ...
    verifier = OnlineVerifier("Lesson 5: 外力应用")
    try:
