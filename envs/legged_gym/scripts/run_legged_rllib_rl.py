...
from envs.legged_gym.scripts.scene_util import generate_height_map_file, clear_scene, publish_terrain, publish_scene
...
def run_rllib_appo_rl(
    ...
    import ray
    import torch
    from envs.legged_gym.scripts import rllib_appo_rl
