...
command = "python"
args = [ "-m", "examples.embodied.wheeled_chassis.run_wheeled_chassis",]
...
python examples/embodied/wheeled_chassis/run_wheeled_chassis.py

# 或使用模块方式
python -m examples.embodied.wheeled_chassis.run_wheeled_chassis
...
```
examples/embodied/wheeled_chassis/
