...
当前版本：26.8.2 | 版本分支：release/26.8.2
...
| OrcaLab 26.8.2 | release/26.8.2（当前） |

正式版本发布后，会将 main 分支的代码合入对应的版本分支（如 release/26.8.2） 版本分支命名格式：release/<主版本>.<次版本>.<修订号> 每个正式版本对应一个版本分支，用于版本追踪和热修复 开发阶段请使用 main 或 dev 分支，正式发布后合入版本分支
