...
robot_entries = {
    "openloong_hand_fix_base": "examples._archived.manipulation.robots.openloong_hand_fix_base:OpenLoongHandFixBase",
    "openloong_gripper_2f85_fix_base": "examples._archived.manipulation.robots.openloong_gripper_fix_base:OpenLoongGripperFixBase",
    "openloong_gripper_2f85_mobile_base": "examples._archived.manipulation.robots.openloong_gripper_mobile_base:OpenLoongGripperMobileBase",
}
