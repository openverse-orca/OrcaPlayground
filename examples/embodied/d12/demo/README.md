...
```
examples/embodied/d12/demo/         # 运行入口
...
python examples/embodied/d12/demo/run_d12_demo.py --mode fixed

# 物体坐标系追踪（物体位置固定但轨迹自动适配）
python examples/embodied/d12/demo/run_d12_demo.py --mode mp

# 带低随机化的追踪（物体位置随机偏移，轨迹自动追踪）
python examples/embodied/d12/demo/run_d12_demo.py --mode rand-low

# 中等随机化
python examples/embodied/d12/demo/run_d12_demo.py --mode rand

# 调试：打印物体在基座系下的位姿
python examples/embodied/d12/demo/run_d12_demo.py --mode dump --dump_keywords C12C Barcode Cardboardbox

# 自定义参数
python examples/embodied/d12/demo/run_d12_demo.py --pose_file pose_mp.yaml --rand_file rand_low.yaml --episodes 10
```
