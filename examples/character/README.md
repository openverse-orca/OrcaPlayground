...
```bash
# 方式1：直接运行（推荐）
python3 examples/character/run_character.py

# 方式2：使用模块方式
python3 -m examples.character.run_character

# 带参数运行
python3 examples/character/run_character.py --orcagym_addr localhost:50051 --agent_name Remy
```
