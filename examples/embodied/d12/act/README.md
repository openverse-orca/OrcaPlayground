...
>
> **📝 对应场景文件**：`examples/embodied/d12/act/d12_act.json`
>
...
```bash
# ACT 闭环推理（推荐）
python examples/embodied/d12/act/run_d12_act.py \
    --checkpoint envs/d12/checkpoints/act_det_pkg_scan/best_model.pt \
    --max_steps 6300 \
    --frame_skip 5 \
    --exec_mode chunk \
    --ref_trajectory examples/embodied/d12/act/ref_trajectory/ref_demo.hdf5 \
    --no_sleep
```

```bash
# ACT 视觉推理
bash examples/embodied/d12/act/run_inference_vision.sh
```
...
command = "python"
args = ["examples/embodied/d12/act/run_d12_act.py",
        "--checkpoint", "envs/d12/checkpoints/act_det_pkg_scan/best_model.pt",
