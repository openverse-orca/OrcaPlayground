...
ENV_ENTRY_POINT = {
    "Actors": "examples.embodied.replicator.actors_env:ActorsEnv",
    "Cameras": "examples.embodied.replicator.cameras_env:CamerasEnv",
    "Lights": "examples.embodied.replicator.lights_env:LightsEnv",
}
