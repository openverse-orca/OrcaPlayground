...
运行方式:
    <conda-base>/envs/orca/bin/python -m unittest tests.test_phase2_revision_e2e
"""
...
# OrcaPlayground 仓根目录
# __file__ = OrcaPlayground/tests/test_phase2_revision_e2e.py
# parents[0] = OrcaPlayground/tests
# parents[1] = OrcaPlayground
_ORCA_PLAYGROUND = pathlib.Path(__file__).resolve().parents[1]
