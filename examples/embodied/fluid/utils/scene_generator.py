...
class SceneGenerator:
    ...
    def __init__(
        ...
        # 基准目录：examples.embodied.fluid 包根（与原先 scene_generator 位于 fluid/ 下时一致）
    ...
    def _resolve_geometry_path(self, geometry_file: str) -> str:
        ...
        3. 相对路径：相对于 examples.embodied.fluid 包根目录，如果不存在则尝试从包中加载
        ...
        # 相对路径：从 examples.embodied.fluid 包根目录解析
