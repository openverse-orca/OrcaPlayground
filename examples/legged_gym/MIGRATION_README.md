...
```python
from examples.legged_gym.utils.onnx_policy import load_onnx_policy
...
```python
from examples.legged_gym.utils.lite3_obs_helper import compute_lite3_obs
...
2. **计算Lite3格式观测**:
```python
from examples.legged_gym.utils.lite3_obs_helper import compute_lite3_obs, get_dof_pos_default_policy
